...
| repeatCount | Float | Used to specify the count to repeat the animation. Can only used in Shake, Pop, Morph, Squeeze, Flash, Wobble, Swing and Rotate animations. Default value is 1.  |
