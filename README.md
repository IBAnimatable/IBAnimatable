...
**The app is made in Interface Builder with `IBAnimatable` without single line of code**. Due to the size of the Gif file, it only demonstrates a subset of features. We can also find the full HD version on [YouTube](https://www.youtube.com/watch?v=dvD8X6J1YLM) or [MP4 on Github]()
