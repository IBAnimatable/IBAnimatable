...
public protocol AnimatableOld: class {
  
  /**
   String value of `AnimationTypeOld` enum
   */
...
public extension AnimatableOld where Self: UIView {
  ...
  public func animate(_ completion: AnimatableCompletion? = nil) {
    guard let unwrappedAnimationTypeString = animationType, animationType = AnimationTypeOld(rawValue: unwrappedAnimationTypeString) else {
      return
    }
    ...
    case .squeezeFadeInLeft:
      squeezeFadeInLeft(completion)
    case .squeezeFadeInRight:
      squeezeFadeInRight(completion)
    case .squeezeFadeInDown:
      squeezeFadeInDown(completion)
    case .squeezeFadeInUp:
      squeezeFadeInUp(completion)
    case .squeezeFadeOutLeft:
      squeezeFadeOutLeft(completion)
    case .squeezeFadeOutRight:
      squeezeFadeOutRight(completion)
    case .squeezeFadeOutDown:
      squeezeFadeOutDown(completion)
    case .squeezeFadeOutUp:
      squeezeFadeOutUp(completion)
    case .zoomIn:
      zoomIn(completion)
    case .zoomOut:
      zoomOut(completion)
  ...
  public func rotate(_ clockwise: Bool = true, completion: AnimatableCompletion? = nil) {
    CALayer.animate({
      ...
      let pi: CGFloat = .pi
      animation.fromValue = clockwise ? 0 : pi * 2
      animation.toValue = clockwise ? pi * 2 : 0
      animation.duration = CFTimeInterval(self.duration)
      animation.repeatCount = self.repeatCount
...
public extension AnimatableOld where Self: UIBarItem {
